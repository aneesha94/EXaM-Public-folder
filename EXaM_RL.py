...
for d in range(start_dataset, end_dataset):
    ...
    # load WTP data
    wtp_df = pd.read_csv("input/WTP_HTE_forPythonEXaMalgorithm/WTP_wdays_all_"+str(d)+".csv")
#    wtp_df = pd.read_csv("temp/08_WTP10_"+str(d)+".csv")
#    wtp_df = pd.read_csv("temp/08_WTP100_"+str(d)+".csv")
#    wtp_df = pd.read_csv("temp/08_WTP1000_"+str(d)+".csv")
#    wtp_df = pd.read_csv("temp/08_WTP100uplus_"+str(d)+".csv")
#    wtp_df = pd.read_csv("temp/08_WTP100uminus_"+str(d)+".csv")
...
df_results.info()
df_results.to_csv('input/df_results.csv')
#df_results.to_csv('input/df_results_mani10.csv')
#df_results.to_csv('input/df_results_mani100.csv')
#df_results.to_csv('input/df_results_mani1000.csv')
#df_results.to_csv('input/df_results_mani100uplus.csv')
#df_results.to_csv('input/df_results_mani100uminus.csv')
