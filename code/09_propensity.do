...
gen p_rct_ = 663/1540
save "$EXaM_temp/09_propensity_$simulation.dta", replace
use "$EXaM_temp/09_propensity_$simulation.dta", clear
sum p_rct_, det
...
graph export "$EXaM_output/09_EXaM_propensity_$simulation.png", replace
graph save "$EXaM_output/09_EXaM_propensity_$simulation", replace
