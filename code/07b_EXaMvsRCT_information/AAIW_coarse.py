...
folder = u"/Users/home/Dropbox/ExperimentalDesignAsMarketDesign/kremer_et_al_app_Jul2018"
...
Name = [folder+u"/temp/07_dataexam_AAIW_coarse_"+unicode(i+1)+u".xlsx" for i in xrange(1000)]
...
Dat = np.zeros(shape=(1000,3))
Name = [folder + u"/temp/07_datarct_AAIW_coarse_"+unicode(i+1)+u".xlsx" for i in xrange(1000)]
