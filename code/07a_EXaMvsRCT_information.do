...
********************************************************************************
	...
	cd		"$EXaM"
	use		"$EXaM_temp/06_p_real_$simulation.dta", clear
	set seed 463
...
save "$EXaM_temp/07_EXaMvsRCT_information_$simulation.dta", replace
...
use "$EXaM_temp/07_EXaMvsRCT_information_$simulation.dta", clear
gen p_RCT = 663/1540
forval n = 1/$simulation {
	...
	*	Prepare for AAIW ExaM
	preserve 
		...
		export excel "$EXaM_temp/07_dataexam_AAIW_`n'.xlsx", replace
	restore
	...
	*	Prepare for AAIW RCT
	preserve 
		...
		export excel "$EXaM_temp/07_datarct_AAIW_`n'.xlsx", replace
	restore
}
...
preserve
	...
	drop p_RCT
	save "$EXaM_temp/07_EXaMvsRCT_information_histogram_$simulation.dta", replace
restore

	use "$EXaM_temp/07_EXaMvsRCT_information_histogram_$simulation.dta", clear
...
*	b ESTIMATES			
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_b_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_b_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_b_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_b_medi_$simulation", replace
	...
	legend(label(1 "RCT") label(2 "EXAM") position(6) symysize(*.5) forces) 
	graph export "$EXaM_output/07_EXaMvsRCT_information_b_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_b_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_b_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_b_mean_$simulation", replace
...
*	STANDARD ERRORS OF b ESTIMATES
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_b_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_b_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_se_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_se_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_b_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_b_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_se_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_se_mean_$simulation", replace
...
*	P-VALUES OF b ESTIMATES
	...
	(histogram p_EXaM_, width(0.05) frac fcolor(none) lcolor(red) lwidth(vthin) ///
		...
		legend(label(1 "RCT") label(2 "EXAM") position(6) symysize(*.5) forces) 
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005_b_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005_b_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_p005_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005_b_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005_b_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_p005_mean_$simulation", replace
...
*	P-VALUES OF b ESTIMATES (Use standard deviation of b as SE, 20171213)
	...
	(histogram p_b_EXaM_, width(0.05) frac fcolor(none) lcolor(red) lwidth(vthin) ///
		...
		legend(label(1 "RCT") label(2 "EXAM") position(6) symysize(*.5) forces) 
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005SD_b_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005SD_b_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005SD_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_p005SD_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005SD_b_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005SD_b_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005SD_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_p005SD_mean_$simulation", replace
...
preserve
	...
	reshape long b_EXaM_ p_EXaM_ b_RCT_ p_RCT_ se_EXaM_ se_RCT_, i(n) j(number)
	drop p_RCT
	save "$EXaM_temp/07_EXaMvsRCT_information_histogram_robust_$simulation.dta", replace
restore



	use "$EXaM_temp/07_EXaMvsRCT_information_histogram_robust_$simulation.dta", clear
...
*	STANDARD ERRORS OF b ESTIMATES
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_b_robust_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_b_robust_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_se_robust_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_se_robust_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_b_robust_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_b_robust_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_se_robust_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_se_robust_mean_$simulation", replace
...
*	P-VALUES OF b ESTIMATES
	...
	(histogram p_EXaM_, width(0.05) frac fcolor(none) lcolor(red) lwidth(vthin) ///
		xline($medi_p_EXaM_, lc(red) lpattern(solid))), ///
		legend(label(1 "RCT") label(2 "EXAM") position(6) symysize(*.5) forces) 
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005_b_robust_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005_b_robust_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005_robust_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_p005_robust_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005_b_robust_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005_b_robust_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005_robust_mean_$simulation.png", replace	
	graph save "$EXaM_output/07_RCT_information_p005_robust_mean_$simulation", replace	
...
preserve
	...
	save "$EXaM_temp/07_EXaMvsRCT_information_histogram_psm_$simulation.dta", replace
restore

	use "$EXaM_temp/07_EXaMvsRCT_information_histogram_psm_$simulation.dta", clear
	egen sd_b_RCT_ = sd(b_RCT)
	egen sd_b_EXaM_ = sd(b_EXaM)
	gen p_b_RCT_ = 2*ttail($degreef, abs(b_RCT_ / sd_b_RCT_))
	gen p_b_EXaM_ = 2*ttail($degreef, abs(b_EXaM_ / sd_b_EXaM_))
...
*	BETA ESTIMATES		
	...
	(histogram b_EXaM_, xline($medi_b_EXaM_, lc(red) lpattern(solid)) width(0.0015) frac fcolor(none) lcolor(red) lwidth(vthin)), ///
	legend(label(1 "RCT") label(2 "EXAM") position(6) symysize(*.5) forces) 
	graph export "$EXaM_output/07_EXaMvsRCT_information_beta_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_beta_medi_$simulation", replace
	...
	(histogram b_EXaM_, xline($mean_b_EXaM_, lc(red) lpattern(solid)) width(0.0015) frac fcolor(none) lcolor(red) lwidth(vthin)), ///
	legend(label(1 "RCT") label(2 "EXAM") position(6) symysize(*.5) forces) 
	graph export "$EXaM_output/07_EXaMvsRCT_information_beta_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_beta_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_beta_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_beta_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_beta_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_beta_mean_$simulation", replace
...
*	STANDARD ERRORS OF BETA ESTIMATES
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_beta_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_beta_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_beta_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_beta_mean_$simulation", replace
...
*	P-VALUES OF beta ESTIMATES (Use standard deviation of b as SE, 20171213)
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005SD_beta_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005SD_beta_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005SD_beta_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005SD_beta_mean_$simulation", replace
...
preserve
	...
	gen n = _n
	reshape long b_EXaM_ b_RCT_ p_EXaM_ p_RCT_ se_EXaM_ se_RCT_, i(n) j(number)
	save "$EXaM_temp/07_EXaMvsRCT_information_histogram_psm_robust_$simulation.dta", replace
restore

	use "$EXaM_temp/07_EXaMvsRCT_information_histogram_psm_robust_$simulation.dta", clear
...
*	STANDARD ERRORS OF BETA ESTIMATES
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_beta_robust_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005SD_beta_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_beta_robust_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_beta_robust_mean_$simulation", replace
