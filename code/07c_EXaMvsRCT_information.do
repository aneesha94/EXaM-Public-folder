...
*	STANDARD ERRORS OF b ESTIMATES
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_b_AAIW_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_b_AAIW_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_se_AAIW_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_se_AAIW_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_se_b_AAIW_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_se_b_AAIW_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_se_AAIW_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_se_AAIW_mean_$simulation", replace
...
*	P-VALUES OF b ESTIMATES
	...
	(histogram p_EXaM_, width(0.05) frac fcolor(none) lcolor(red) lwidth(vthin) ///
		...
		legend(label(1 "RCT") label(2 "EXAM") position(6) symysize(*.5) forces) 
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005_b_AAIW_medi_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005_b_AAIW_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005_AAIW_medi_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_p005_AAIW_medi_$simulation", replace
	...
	graph export "$EXaM_output/07_EXaMvsRCT_information_p005_b_AAIW_mean_$simulation.png", replace
	graph save "$EXaM_output/07_EXaMvsRCT_information_p005_b_AAIW_mean_$simulation", replace
	...
	graph export "$EXaM_output/07_RCT_information_p005_AAIW_mean_$simulation.png", replace
	graph save "$EXaM_output/07_RCT_information_p005_AAIW_mean_$simulation", replace
