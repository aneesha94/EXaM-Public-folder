...
%old output
%delete /Users/home/Dropbox/ExperimentalDesignAsMarketDesign/kremer_et_al_app(aug2017)/output/1000/02_mlogitreg_wtp_col1.out
%diary /Users/home/Dropbox/ExperimentalDesignAsMarketDesign/kremer_et_al_app(aug2017)/output/1000/02_mlogitreg_wtp_col1.out
...
col1=table({'Spring protection treatment indicator Mean';'Spring protection treatment indicator Mean(sd)';
...
col1.Properties.VariableNames={'Column1';'estimations'};
writetable(col1,'02_col1.csv','Delimiter',',','QuoteStrings',true);
type '02_col1.csv';
